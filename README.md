...
| `use-bicep-from-path`                 | When set to 'true', use the Bicep executable found on PATH for compilation. Falls back to downloading Bicep if not found. | `true`, `false`                                                                                                                                  | No       |
