...
const whatif_1 = require("../src/whatif");
describe("formatJson tests", () => {
    it("test_leaf", () => {
        ...
        testData.forEach(([expected, value]) => {
            expect((0, whatif_1.formatJson)(value, "debug")).toStrictEqual(expected);
        });
    });
...
Resource changes: 1 to create, 3 to modify, 1 to ignore.`;
        expect((0, whatif_1.formatWhatIfOperationResult)({ changes }, "debug")).toBe(expected);
    });
    it("test_resource_changes_stats", () => {
        ...
        const result = (0, whatif_1.formatWhatIfOperationResult)({ changes }, "debug");
...
`;
    ...
    it("should sort resource IDs within a scope", () => {
        const changes = [
            ...
            {
                resourceId: "/subscriptions/00000000-0000-0000-0000-000000000001/resourceGroups/rg1/providers/p7/foo",
                changeType: "Delete",
            },
            {
                resourceId: "/subscriptions/00000000-0000-0000-0000-000000000001/resourceGroups/rg1/providers/p8/foo",
                ...
                delta: [
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            // eslint-disable-next-line @typescript-eslint/no-explicit-any
                            { path: "5", propertyChangeType: "Delete", before: 12345 },
                        ],
                    },
                ],
            },
...
`;
    ...
    it("fixes up a dodgy SDK response", () => {
        const changes = [
            {
                resourceId: "/subscriptions/00000000-0000-0000-0000-000000000004/resourceGroups/rg4/providers/Microsoft.DocumentDB/databaseAccounts/myaccount",
                changeType: "Modify",
                delta: [
                    {
                        propertyChangeType: "Modify",
...
`;
    ...
    it("handles https://github.com/Azure/bicep-deploy/issues/162 correctly", () => {
        const changes = [
            {
                resourceId: "/subscriptions/a1bfa635-f2bf-42f1-86b5-848c674fc321/providers/Microsoft.Authorization/roleDefinitions/8c890531-237b-58a7-964b-6aa90045ff37",
                changeType: "Create",
                after: {
...
//# sourceMappingURL=whatif.test.js.map